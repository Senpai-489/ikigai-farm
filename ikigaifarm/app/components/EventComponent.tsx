        ...
        <div className='flex flex-col justify-between gap-6 p-6 sm:p-8 lg:p-10'>
          ...
          <div className='flex flex-wrap gap-3'>
            ...
            <Link href='/Download-Brochure'>
              <button className='rounded-full border border-[#122a02] px-5 py-3 text-sm font-medium text-[#122a02] transition-colors duration-300 hover:bg-[#122a02] hover:text-amber-100'>Download Brochure</button>
            </Link>
          </div>
        </div>
